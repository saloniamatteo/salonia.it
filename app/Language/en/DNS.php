...
return [
	...
	"intro"			=> [
		"desc"		=> "What is a DoH server? A <strong>DNS-over-HTTPS server</strong> is a server that receives a <strong>%s</strong> via <strong>%s</strong>. A goal of the method is to increase user privacy and security by preventing eavesdropping and manipulation of DNS data by <strong>%s</strong> attacks by using the HTTPS protocol to encrypt the data.",
		"dns"		=> "DNS query",
