<?php
// Italian dict file for services
return [
	"title"			=> "Servizi",
	"desc"			=> "Servizi offerti da Salonia Infrastrutture Digitali.",
	"welcome"		=> [
		"title"		=> "Servizi",
		"desc"		=> "Scopri tutti i servizi offerti da <strong>Salonia Infrastrutture Digitali</strong>.",
	],
	"go-to"			=>	[
		"title"		=> "Vai a",
